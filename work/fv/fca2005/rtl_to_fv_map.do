...
# Generated on: Thu Aug 20 16:20:23 CEST 2026 (Thu Aug 20 14:20:23 UTC 2026)
...
set logfile fv/fca2005/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fca2005 -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/apps/CADENCE/DDI251/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/apps/CADENCE/DDI251/GENUS251/tools.lnx86"
set env(CW_DIR) "/apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /apps/CADENCE/DDI251/GENUS251/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /apps/DESIGN_KITS/XFAB_xh018/XKIT/xh018/diglibs/D_CELLS_HD/v6_0/liberty_LPMOS/v6_0_0/PVT_1_80V_range/D_CELLS_HD_LPMOS_slow_1_62V_85C.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/edu4chip_18/project_calendar/src/fca2005.sv
elaborate_design -golden -root {fca2005} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fca2005/fv_map.v.gz
elaborate_design -revised -root {fca2005}
...
set_analyze_option -mapping_file fv/fca2005/fv_map.map.do
...
write_compared_points noneq.compared_points.fca2005.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fca2005.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fca2005.rtl.fv_map.rpt
